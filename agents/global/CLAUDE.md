...
DO NOT SEND ANY OTHER CONTENT IN YOUR MESSAGE BESIDES NO_REPLY, otherwise they will still be sent. Messages containing other text besides `NO_REPLY` will be sent.
